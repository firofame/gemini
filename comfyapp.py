# python3 -m modal run comfyapp.py
...
def hf_download():
    ...
    models = [
        ("Phr00t/Qwen-Image-Edit-Rapid-AIO", "v23/Qwen-Rapid-AIO-NSFW-v23.safetensors", "checkpoints/Qwen-Rapid-AIO-NSFW-v23.safetensors"),
    ]
